...
export default function FacultyHome() {
  ...
  useEffect(() => {
    ...
    async function getDepartmentStudents(department) {
      try {
        const url =
          "http://127.0.0.1:9000/student/get-all-students-by-department/" +
          department;
        const response = await axios.get(url, {
          headers: {
            "Content-Type": "application/json",
  ...
  async function uploadImage(event) {
    ...
    try {
      const response = await axios.post(
        "http://127.0.0.1:9000/faculty/set-faculty-image",
        formData,
        {
          headers: {
  ...
  async function getCertifications() {
    try {
      const url =
        "http://127.0.0.1:9000/faculty-certification/get-all-certifications-by-id";
      const response = await axios.get(url, {
        headers: {
          "Content-Type": "application/json",
          Authorization: "Bearer " + jwtToken,
      ...
      const updatedCertifications = await Promise.all(
        response.data.map(async (certification) => {
          try {
            const response = await axios.get(
              "http://127.0.0.1:9000" + certification.certify,
              {
                headers: {
                  Authorization: "Bearer " + jwtToken,
                },
  ...
  async function getProjects() {
    try {
      const url =
        "http://127.0.0.1:9000/faculty-project/get-all-projects-by-id";
      const response = await axios.get(url, {
        headers: {
          "Content-Type": "application/json",
          Authorization: "Bearer " + jwtToken,
  ...
  async function getDocuments() {
    try {
      ...
      const aadharResponse = await axios.get(
        "http://127.0.0.1:9000" + documentsData.aadharCard,
        {
          headers: {
            Authorization: "Bearer " + jwtToken,
          },
      ...
      const panResponse = await axios.get(
        "http://127.0.0.1:9000" + documentsData.panCard,
        {
          headers: {
            Authorization: "Bearer " + jwtToken,
          },
  ...
  async function uploadPassword(e) {
    ...
    try {
      const response = await axios.post(
        "http://127.0.0.1:9000/faculty/change-password",
        {
  ...
  async function uploadStudentPassword(e) {
    ...
    try {
      const response = await axios.post(
        "http://127.0.0.1:9000/student/change-password-hod/" +
