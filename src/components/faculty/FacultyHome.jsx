...
export default function FacultyHome() {
    ...
    useEffect(() => {
        ...
        async function getFacultyObject() {
            try {
                const url = "http://127.0.0.1:9000/faculty/get-faculty/" + jwtDecode(jwtToken).sub;
        ...
        async function getFacultyImage(imageUrl) {
            try {
                ...
                setFaculty(prevFaculty => ({ ...prevFaculty, profilePicture: URL.createObjectURL(blob) }));
            } catch (error) {
    ...
    async function uploadImage(event) {
        ...
        try {
            const response = await axios.post("http://127.0.0.1:9000/faculty/set-faculty-image", formData, {
                headers: {
    ...
    async function uploadCertification(e) {
        ...
        try {
            const response = await axios.post(
                'http://127.0.0.1:9000/faculty-certification/add-certification',
                formData,
                {
                    headers: {
                        'Content-Type': 'multipart/form-data',
    ...
    async function getCertifications() {
        try {
            const url = "http://127.0.0.1:9000/faculty-certification/get-all-certifications-by-id";
            const response = await axios.get(url, {
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': 'Bearer ' + jwtToken
            ...
            const updatedCertifications = await Promise.all(response.data.map(async (certification) => { 
                try {
                    const response = await axios.get("http://127.0.0.1:9000" + certification.certify, {
                        headers: {
                            'Authorization': 'Bearer ' + jwtToken,
                        },
                        responseType: 'arraybuffer'
    ...
    async function uploadExperience(e) {
        ...
        try {
            const response = await axios.post(
                'http://127.0.0.1:9000/experience/add-experience',
                experienceData,
                {
                    headers: {
                        'Content-Type': 'application/json',
            ...
            swal("Good job!", "Experience Uploaded!", "success");
    ...
    async function getExperiences(){
        try {
            const url = "http://127.0.0.1:9000/experience/get-all-experiences-by-id";
            const response = await axios.get(url, {
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': 'Bearer ' + jwtToken
    ...
    async function uploadResearchPaper(e) {
        ...
        try {
            const response = await axios.post(
                'http://127.0.0.1:9000/research-papers/add-paper',
                paperData,
                {
                    headers: {
                        'Content-Type': 'application/json',
            ...
            swal("Good job!", "Paper Uploaded!", "success");
    ...
    async function getResearchPapers() {
        try {
            const url = "http://127.0.0.1:9000/research-papers/get-all-papers-by-id";
            const response = await axios.get(url, {
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': 'Bearer ' + jwtToken
    ...
    async function uploadProject(e){
        ...
        try {
            const response = await axios.post(
              'http://127.0.0.1:9000/faculty-project/add-project',
              {
    ...
    async function getProjects() {
        try {
            const url = "http://127.0.0.1:9000/faculty-project/get-all-projects-by-id";
            const response = await axios.get(url, {
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': 'Bearer ' + jwtToken
    ...
    async function uploadDocuments(e){
        ...
        try{
            const response = await axios.post(
                'http://127.0.0.1:9000/personal-documents/add-documents',
                formData,
                {
                    headers: {
                        'Content-Type': 'multipart/form-data',
            ...
            setRenderPage(true)
            swal("Good job!", "Personal Documents Uploaded!", "success");
    ...
    async function getDocuments() {
        try {
            const url = "http://127.0.0.1:9000/personal-documents/get-documents";
            const response = await axios.get(url, {
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': 'Bearer ' + jwtToken
            ...
            const aadharResponse = await axios.get("http://127.0.0.1:9000" + documentsData.aadharCard, {
                headers: {
                    'Authorization': 'Bearer ' + jwtToken,
                },
                responseType: 'arraybuffer'
            ...
            const panResponse = await axios.get("http://127.0.0.1:9000" + documentsData.panCard, {
                headers: {
                    'Authorization': 'Bearer ' + jwtToken,
                },
                responseType: 'arraybuffer'
            ...
            const aadharBlob = new Blob([aadharResponse.data], { type: aadharResponse.headers['content-type'] });
            const panBlob = new Blob([panResponse.data], { type: panResponse.headers['content-type'] });
    ...
    async function uploadSocial(e){
        ...
        try {
            const response = await axios.post(
              'http://127.0.0.1:9000/social/add-social',
              {
            ...
            setRenderPage(true);
            swal("Good job!", "Social Uploaded!", "success");
                    ...
                    <div className="col-xl-6 col-lg-8 offset-lg-2 offset-xl-3">
                            ...
                            <div className="card-body">
                                <div className="row mt-3">
                                    <div className="col-sm-2 col-12 justify-content-sm-end align-items-sm-top d-flex">
                                        {!profilePictureError ? (
                                            <img src={faculty.profilePicture} alt="Profile" className='img-fluid img-faculty-profile' />
                                        ) : (
                                            <img src={upload_image_logo} onClick={() => document.getElementById('fileInput').click()} alt="Upload" className='img-fluid img-upload-file' />
                                        )}
                                        <input id="fileInput" type="file" accept="image/*" onChange={uploadImage} className='img-upload-file-input'  />
                                    </div>
                                    <div className="col-sm-10 mt-3 mt-sm-0">
                                        <h3>{faculty.facultyName}</h3>
                                        <div className="mt-2 text-muted">
                                            <b>Faculty ID: {username} | Dept: {faculty.department}</b>
                                        </div>
                                        <div className="mt-2 text-muted">
                                        ...
                                        <div className="row mt-2">
                                            ...
                                            <div className="col-lg-6 col-sm-6 col-12 text-muted">
                                                <img src={email_logo} alt="email_logo" className='img-fluid icons-home-page' /> {faculty.emailId}
                                            </div>
                                        </div>
                                                    ...
                                                    socialProfileError ? (
                                                        <>
                                                            <a href={social.linkedin} target='_blank' rel="noreferrer">
                                                                <img src={linkedin_student_logo} alt="linkedin_student_logo" className='img-fluid linkedin-logo-faculty' />
                                                            </a>
                                                            <a href={social.github} target='_blank' rel="noreferrer">
                                                                <img src={github_student_logo} alt="github_student_logo" className='img-fluid github-logo-faculty' />
                                                            </a>
                                                        </>
                                                    ) : (
                                                        <button data-bs-toggle="modal" data-bs-target="#socialBackdrop" className='btn btn-dark text-white'>Add Social?</button>
                                                    )
                                                }
                                                </div>
                                            </div>
                        ...
                        <div className="card mt-4 shadow"> 
                            <div className="card-body">
                                <div className="row"> 
                                    <div className="col-12">
                                        <button type="button" className="bi btn bi-plus-lg float-end" data-bs-toggle="modal" data-bs-target="#achievementBackdrop"></button>
                                        <h5><b>Certifications</b></h5>
                                        Talk about the certifications you have completed, What projects you undertook and what special skills you learned.
                                        <button type="button" className="bi btn bi-caret-down-fill float-end" data-bs-toggle="collapse" data-bs-target="#certificationsDropdown" aria-expanded="false" aria-controls="certificationsDropdown"></button> 
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="card mt-4 shadow"> 
                            <div className="card-body">
                                <div className="row"> 
                                    <div className="col-12">
                                        <button type="button" className="bi btn bi-plus-lg float-end" data-bs-toggle="modal" data-bs-target="#researchPaperBackdrop"></button>
                                        <h5><b>Research Papers</b></h5>
                                        Talk about the Research Papers you have completed, What projects you undertook and what special skills you learned.
                                        <button type="button" className="bi btn bi-caret-down-fill float-end" data-bs-toggle="collapse" data-bs-target="#researchPapersDropdown" aria-expanded="false" aria-controls="researchPapersDropdown"></button> 
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="card mt-4 shadow"> 
                            <div className="card-body">
                                <div className="row"> 
                                    <div className="col-12">
                                        <button type="button" className="bi btn bi-plus-lg float-end" data-bs-toggle="modal" data-bs-target="#experienceBackdrop"></button>
                                        <h5><b>Experiences</b></h5>
                                        Talk about the experiences you have completed, What projects you undertook and what special skills you learned.
                                        <button type="button" className="bi btn bi-caret-down-fill float-end" data-bs-toggle="collapse" data-bs-target="#experiencesDropdown" aria-expanded="false" aria-controls="experiencesDropdown"></button> 
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="card mt-4 shadow"> 
                            <div className="card-body">
                                <div className="row">
                                    <div className="col-12">
                                        <button type="button" className="bi btn bi-plus-lg float-end" data-bs-toggle="modal" data-bs-target="#projectBackdrop"></button>
                                        <h5><b>Projects</b></h5>
                                        Talk about the projects that made you proud and contributed to your learnings.
                                        <button type="button" className="bi btn bi-caret-down-fill float-end" data-bs-toggle="collapse" data-bs-target="#projectsDropdown" aria-expanded="false" aria-controls="projectsDropdown"></button> 
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="card mt-4 shadow"> 
                            <div className="card-body">
                                <div className="row">
                                    <div className="col-12">
                                        {!addDocuments && 
                                            <button type="button" className="bi btn bi-plus-lg float-end" data-bs-toggle="modal" data-bs-target="#personalDocumentBackdrop"></button>
                                        }
                                        <h5><b>Personal Documents</b></h5>
                                        Talk about the Personal Documents that made you proud and contributed to your learnings.
                                        <button type="button" className="bi btn bi-caret-down-fill float-end" data-bs-toggle="collapse" data-bs-target="#personalDocumentsDropdown" aria-expanded="false" aria-controls="personalDocumentsDropdown"></button> 
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <Modals uploadAchievement={uploadCertification} uploadExperience={uploadExperience} uploadResearchPaper={uploadResearchPaper} uploadProject={uploadProject} uploadDocuments={uploadDocuments} uploadSocial={uploadSocial} />
                    </div>
                </div>
            </div>
        </div>
