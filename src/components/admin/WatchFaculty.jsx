...
export default function WatchFaculty() {
  ...
  async function getFacultySocial() {
    try {
      const url =
        "http://127.0.0.1:9000/social/get-all-socials-by-id/" + facultyId;
      const response = await axios.get(url, {
        headers: {
          "Content-Type": "application/json",
          Authorization: "Bearer " + jwtToken,
  ...
  async function getExperiences() {
    try {
      const url =
        "http://127.0.0.1:9000/experience/get-all-experiences-by-id/" +
        facultyId;
      const response = await axios.get(url, {
        headers: {
          "Content-Type": "application/json",
  ...
  async function getResearchPapers() {
    try {
      const url =
        "http://127.0.0.1:9000/research-papers/get-all-papers-by-id/" +
        facultyId;
      const response = await axios.get(url, {
        headers: {
          "Content-Type": "application/json",
  ...
  async function getDocuments() {
    try {
      const url =
        "http://127.0.0.1:9000/personal-documents/get-documents/" + facultyId;
      const response = await axios.get(url, {
        headers: {
          "Content-Type": "application/json",
          Authorization: "Bearer " + jwtToken,
