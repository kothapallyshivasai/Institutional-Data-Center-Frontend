...
async function getUniqueCertificationsTechnical(logoutUser, jwtToken) {
  try {
    const url =
      "http://127.0.0.1:9000/certification/get-unique-certifications-technical";
    const response = await axios.get(url, {
      headers: {
        "Content-Type": "application/json",
        Authorization: "Bearer " + jwtToken,
...
async function getUniqueCertificationsNonTechnical(logoutUser, jwtToken) {
  try {
    const url =
      "http://127.0.0.1:9000/certification/get-unique-certifications-non-technical";
    const response = await axios.get(url, {
      headers: {
        "Content-Type": "application/json",
        Authorization: "Bearer " + jwtToken,
...
async function getSkillsByStudent(jwtToken, studentId) {
  try {
    const url =
      "http://127.0.0.1:9000/skill/get-all-unique-skills-by-student-id/" +
      studentId;
    const response = await axios.get(url, {
      headers: {
        "Content-Type": "application/json",
...
async function getCertificationsByStudent(jwtToken, studentId) {
  try {
    const url =
      "http://127.0.0.1:9000/certification/get-unique-certifications-by-student-id/" +
      studentId;
    const response = await axios.get(url, {
      headers: {
        "Content-Type": "application/json",
...
async function getInternshipsByStudent(jwtToken, studentId) {
  try {
    const url =
      "http://127.0.0.1:9000/internship/get-unique-internships-by-student-id/" +
      studentId;
    const response = await axios.get(url, {
      headers: {
        "Content-Type": "application/json",
...
async function getUniqueStudentIdsBySKill(jwtToken) {
  try {
    const url =
      "http://127.0.0.1:9000/skill/get-all-unique-student-ids-by-skill";
    const response = await axios.get(url, {
      headers: {
        "Content-Type": "application/json",
        Authorization: "Bearer " + jwtToken,
...
async function getUniqueStudentIdsByCertifcation(jwtToken) {
  try {
    const url =
      "http://127.0.0.1:9000/certification/get-all-unique-student-ids-by-certification";
    const response = await axios.get(url, {
      headers: {
        "Content-Type": "application/json",
        Authorization: "Bearer " + jwtToken,
...
async function getUniqueStudentIdsByInternship(jwtToken) {
  try {
    const url =
      "http://127.0.0.1:9000/internship/get-all-unique-student-ids-by-internship";
    const response = await axios.get(url, {
      headers: {
        "Content-Type": "application/json",
        Authorization: "Bearer " + jwtToken,
