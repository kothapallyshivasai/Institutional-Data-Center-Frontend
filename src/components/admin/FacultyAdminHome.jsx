...
async function getUniqueFacultyIdsByExperience(jwtToken) {
  try {
    const url =
      "http://127.0.0.1:9000/experience/get-all-unique-faculty-ids-by-experience";
    const response = await axios.get(url, {
      headers: {
        "Content-Type": "application/json",
        Authorization: "Bearer " + jwtToken,
...
async function getExperiencesByFaculty(jwtToken, facultyId) {
  try {
    const url =
      "http://127.0.0.1:9000/experience/get-unique-experiences-by-faculty-id/" +
      facultyId;
    const response = await axios.get(url, {
      headers: {
        "Content-Type": "application/json",
...
async function getUniqueFacultyIdsByPaper(jwtToken) {
  try {
    const url =
      "http://127.0.0.1:9000/research-papers/get-all-unique-faculty-ids-by-paper";
    const response = await axios.get(url, {
      headers: {
        "Content-Type": "application/json",
        Authorization: "Bearer " + jwtToken,
...
async function getPapersByFaculty(jwtToken, facultyId) {
  try {
    const url =
      "http://127.0.0.1:9000/research-papers/get-unique-papers-by-faculty-id/" +
      facultyId;
    const response = await axios.get(url, {
      headers: {
        "Content-Type": "application/json",
...
async function getUniqueFacultyIdsByCertification(jwtToken) {
  try {
    const url =
      "http://127.0.0.1:9000/faculty-certification/get-all-unique-faculty-ids-by-certification";
    const response = await axios.get(url, {
      headers: {
        "Content-Type": "application/json",
        Authorization: "Bearer " + jwtToken,
...
async function getCertificationsByFaculty(jwtToken, facultyId) {
  try {
    const url =
      "http://127.0.0.1:9000/faculty-certification/get-unique-certifications-by-faculty-id/" +
      facultyId;
    const response = await axios.get(url, {
      headers: {
        "Content-Type": "application/json",
